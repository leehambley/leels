...
pub const FIELDS: &[Field] = &[
    ...
    field!(
        ...
        "Jog speed 1",
        "mm/s",
        "Speed for the smallest jog distance (tap and start of a hold). Holds step up to the next speed.",
        Decimal4,
        1,
        10_000_000,
        jog_speeds_du_per_s[0]
    ),
    field!("jog_speed_2", "Jogging", "Jog speed 2", "mm/s", "", Decimal4, 1, 10_000_000, jog_speeds_du_per_s[1]),
    field!("jog_speed_3", "Jogging", "Jog speed 3", "mm/s", "", Decimal4, 1, 10_000_000, jog_speeds_du_per_s[2]),
    field!(
        "jog_speed_4",
        "Jogging",
        "Jog speed 4",
        "mm/s",
        "Speed for the largest jog distance, and the top hold speed.",
        Decimal4,
        1,
        10_000_000,
    ...
    field!(
        ...
        "Speed up every",
        "ms",
        "Time at each hold speed before stepping up to the next.",
        Integer,
        100,
        60_000,
        jog_level_every_ms
