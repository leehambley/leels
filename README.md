...
- **C6**: placeholder pins (encoder 2/3, STEP 4, DIR 5, ENA 6, Nextion TX 22 / RX 23).
  The C6 is 3.3 V only, so the encoder needs level shifting.
...
- **Stops**: pressing Stop L or Stop R sets that stop at the current position,
  ...
  To position the carriage, engage and turn the chuck by hand.
...
compensation, TPI entry, jogging buttons, the max-travel E-stop, and
